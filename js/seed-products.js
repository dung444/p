...
(function () {
  ...
  if (existing && existing.length > 0) {
    console.log(
      "[seed-products] Đã có dữ liệu products trong localStorage, không ghi đè."
    );
    return;
  }
  ...
  const products = [
    ...
    {
      id: "C002",
      name: "Bộ dụng cụ vệ sinh nhà tắm 5 món",
      price: 210000,
      category: "Vệ sinh & Làm sạch",
      subcategory: "Dụng cụ vệ sinh",
      image: "images/bo-dung-cu-ve-sinh-5mon.jpg",
      description:
        "Bộ 5 món gồm bàn chải cọ bồn cầu, chổi quét, gạt nước và các dụng cụ vệ sinh đa năng.",
    },
    {
      id: "C003",
